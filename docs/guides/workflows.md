...
5. Update the hook catalog and counts: `docs/reference/hooks.md` (catalog table and file tree), `hooks/README.md`, `README.md` and `CLAUDE.md` (both carry a hook count and how many ship enabled).
