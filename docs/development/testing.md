...
At this commit: 10 Go packages with tests; `dangerous-cmd-guard.test.sh` 169 cases, `fail-closed.test.sh` 10, `secret-guard.test.sh` 37; `dangerous-cmd-guard.test.js` 170, `devexp-plugin.test.js` 130, `secret-guard.test.js` 38; `uninstall.test.sh` 94, `install.test.sh` 17, `remote-install.test.sh` 24.
