...
- **Unused packages found** → suggest invoking `dev-agent` to remove them, passing the unused package list as context — it removes each from the manifest and lockfile and verifies build and tests still pass.
