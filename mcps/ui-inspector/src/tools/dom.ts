...
export function registerDom(server: McpServer) {
  server.tool(
    'get_dom',
    'Get the HTML DOM structure of the current page or a scoped element. Useful for inspecting component nesting and markup quality.',
    {
      selector: z
        .string()
        .optional()
