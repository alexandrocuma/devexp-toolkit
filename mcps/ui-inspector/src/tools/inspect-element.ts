...
export function registerInspectElement(server: McpServer) {
  server.tool(
    'inspect_element',
    'Get computed CSS styles and bounding rect for a CSS selector. Use to diagnose spacing, sizing, overflow, and layout issues.',
    {
