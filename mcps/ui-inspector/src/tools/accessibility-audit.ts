...
export function registerAccessibilityAudit(server: McpServer) {
  server.tool(
    'run_accessibility_audit',
    'Run an axe-core accessibility audit on the current page. Returns WCAG violations with impact level and fix guidance.',
    {
      include: z
        .string()
        .optional()
