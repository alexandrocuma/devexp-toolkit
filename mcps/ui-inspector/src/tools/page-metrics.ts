...
export function registerPageMetrics(server: McpServer) {
  server.tool(
    'get_page_metrics',
    'Get page performance metrics: navigation timing, paint events (FP, FCP), resource count, and cumulative layout shift (CLS).',
    {},
    async () => {
