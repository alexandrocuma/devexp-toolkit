...
export function registerNavigate(server) {
    server.tool('navigate', 'Navigate the browser to a URL and wait for the page to load. Call this before any other inspection tool.', {
